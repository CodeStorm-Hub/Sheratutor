<!-- Title: Model upgrades and switches | Category: Models/Explore Foundry Models/Model versions and lifecycle/Model upgrades and switches | URL: foundry-models/concepts/model-migration -->

---
layout: Conceptual
title: 'Model migration: upgrade or switch models in Microsoft Foundry - Microsoft Foundry | Microsoft Learn'
canonicalUrl: https://learn.microsoft.com/en-us/azure/foundry/foundry-models/concepts/model-migration
...
locale: en-us
document_id: f66957ea-b306-aace-ddf9-4518350b1c65
document_version_independent_id: 9e51bcaa-50b5-6f61-6585-385c19f3f0ed
updated_at: 2026-08-26T22:14:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/azure-ai-docs-pr/blob/live/articles/foundry/foundry-models/concepts/model-migration.md
gitcommit: https://github.com/MicrosoftDocs/azure-ai-docs-pr/blob/b8a1b05895412b558c94a29255eecbc256bcbb8e/articles/foundry/foundry-models/concepts/model-migration.md
...
toc_rel: ../../toc.json
word_count: 3497
asset_id: foundry/foundry-models/concepts/model-migration
moniker_range_name: 
monikers: []
item_type: Content
source_path: articles/foundry/foundry-models/concepts/model-migration.md
cmProducts:
...
platformId: e4e8d8e0-1603-9936-eb80-6612d20aa93b
---

# Model migration: upgrade or switch models in Microsoft Foundry - Microsoft Foundry | Microsoft Learn
...
- **Prepare early.** Freeze the dataset and success criteria in Before you migrate, before you Adapt. The moment those change, your source and target stop being comparable.
...
The evaluators are ready to run, but curating a domain-relevant test set from *your own* production traffic is hands-on work for model (non-agent) workloads. This need is why the preparation step pays for itself.
