...
5. Select **View Traces with Agent Runs**. The side panel shows all the traces generated by agent runs.
    ...
    [![Screenshot showing the Agents (Preview) section in Azure Monitor displaying multiple runs.](../media/langchain-agents/langchain-monitor-runs.png)](../media/langchain-agents/langchain-monitor-runs.png#lightbox)
6. Select one of the traces. You should see the details.

    [![Screenshot showing the trace details of the selected run.](../media/langchain-agents/langchain-monitor-trace.png)](../media/langchain-agents/langchain-monitor-trace.png#lightbox)

## View traces in Foundry Control Plane

If you deployed your LangGraph or LangChain solution, you can register that deployment into [Foundry Control Plane](../../control-plane/overview) to gain visibility and governance.

[Register your application into Foundry Control Plane](../../control-plane/register-custom-agent) to view traces in the Foundry portal.

Follow these steps:

1. Ensure that you meet the requirements to use the Foundry Control Plane custom agent capability:

    - An [AI gateway configured in your Foundry resource](../../configuration/enable-ai-api-management-gateway-portal#create-an-ai-gateway). Foundry uses Azure API Management to register agents as APIs.
...
2. Ensure that you have [observability configured in the project](../../control-plane/monitoring-across-fleet).
...
12. The **Traces** section shows one entry for each HTTP call made to the agent's endpoint.
    ...
    [![Screenshot of a call to the agent's endpoint under the route for runs and streams.](../../control-plane/media/register-custom-agent/custom-agent-trace.png)](../../control-plane/media/register-custom-agent/custom-agent-trace.png#lightbox)
