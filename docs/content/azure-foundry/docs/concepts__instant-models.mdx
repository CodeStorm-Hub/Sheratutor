...
| Need reserved capacity or [predictable throughput](foundry-models__concepts__deployment-types) | Deployment |
...
| Need [data residency](foundry-models__concepts__deployment-types) in a specific region | Deployment |
