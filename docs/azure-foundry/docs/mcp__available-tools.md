<!-- Title: Available tools and sample prompts | Category: Developer tools and integrations/Foundry MCP Server (preview)/Available tools and sample prompts | URL: mcp/available-tools -->

---
layout: Conceptual
title: Explore available tools and example prompts for Foundry MCP Server (preview) - Microsoft Foundry | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/azure/foundry/mcp/available-tools
...
locale: en-us
document_id: 431d242b-67d0-e669-c403-472e59756f0a
document_version_independent_id: 48892566-38e1-a16b-7fca-d5717cf0da2c
updated_at: 2026-08-19T06:06:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/azure-ai-docs-pr/blob/live/articles/foundry/mcp/available-tools.md
gitcommit: https://github.com/MicrosoftDocs/azure-ai-docs-pr/blob/5a7dfbb80587bb692d189271cfc9a4afddcb9eeb/articles/foundry/mcp/available-tools.md
git_commit_id: 5a7dfbb80587bb692d189271cfc9a4afddcb9eeb
site_name: Docs
depot_name: Learn.azure-ai
page_type: conceptual
toc_rel: ../toc.json
word_count: 4385
asset_id: foundry/mcp/available-tools
moniker_range_name: 
monikers: []
item_type: Content
source_path: articles/foundry/mcp/available-tools.md
cmProducts:
...
platformId: a1a8f4e2-d267-0957-277b-9bcf56e81582
---

# Explore available tools and example prompts for Foundry MCP Server (preview) - Microsoft Foundry | Microsoft Learn
...
- "Use `model_deploy_managed_compute` to deploy `openai--gpt-oss-20b` as `gpt-oss-managed` using its A100\_80GB deployment template."
...
- "Show me A100\_80GB, H100\_80GB, MI300\_192GB, and H200\_141GB accelerator quota in East US 2."
